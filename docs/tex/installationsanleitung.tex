...
\section*{Test-Script für Dozenten/Prüfer}
Für die Demonstration der Dashboard-Funktionalität (Auto-Bewegung auf Roadmap) steht ein interaktives Test-Script zur Verfügung:

\begin{verbatim}
python3 set_exam_date_past.py
\end{verbatim}

\textbf{Empfohlener Demo-Workflow:}
\begin{enumerate}[itemsep=2pt]
    \item \textbf{Option 8}: Einschreibedatum zurücksetzen (z.B. 90 Tage)
    \item \textbf{Option 7}: SCHNELLTEST ausführen
    \begin{itemize}[itemsep=0pt]
        \item Termin-ID eingeben (z.B. 1)
        \item Tage zurück: 30
        \item Note: 2.0
    \end{itemize}
    \item Dashboard im Browser neu laden
    \item \textbf{Ergebnis}: Auto hat sich bewegt! 🚗
    \item \textbf{Option 5}: Noten-Übersicht anzeigen
\end{enumerate}

\textit{Hinweis:} Das Script verhindert logische Fehler (z.B. Prüfung vor Einschreibung). Detaillierte Anleitung in \texttt{README\_set\_exam\_date\_past.md}
